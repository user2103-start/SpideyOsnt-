...
async def send_long_message(update: Update, text: str, chat_id: int = None):
    ...
    MAX_LENGTH = 4000  # Telegram limit is 4096, keeping safe
...
def format_number_response(api_data):
    """Format number API response - supports multiple results"""
    try:
